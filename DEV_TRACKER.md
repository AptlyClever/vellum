...
Bootstrap / canon only. No governing CFD yet.
...
- Local intake runner (vault skeleton + register for 37 Humble items; no keys; no raw assets in git).
- Unity tier contents unresolved until redemption / library inspection.
- Optional Axiom surface later (browse register / intake status) — not required for first slice.
