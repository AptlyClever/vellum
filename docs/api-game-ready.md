...
This path is retained for targeted/manual manifest ingestion. Normal Factory
...
Ingest is capped at 500 rows per run. Factory smart-ZIP packing sends at most
