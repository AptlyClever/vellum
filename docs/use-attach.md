...
**Land:** copy PNG →  
`/srv/axiom/config/hails/glyph-hero-images/vellum-<asset_id>-<shortid>.png`
...
**Land:** create once:  
`/srv/lcard/media/vellum/` + `media/manifest.json`
...
**Land:**  
`/srv/bandit/web/static/vellum/<asset_id>/hero.png`
