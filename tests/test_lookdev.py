...
def test_infer_lanes_from_fit() -> None:
    ...
    assert "threshold-affairs" in infer_lanes("Threshold Affairs interiors; motel anomaly")
    assert "field-ops" not in infer_lanes("Threshold Affairs interiors")
    assert "threshold-affairs" not in infer_lanes("Field Ops lookdev")
