...
def test_worker_prepares_stage_and_updates_intake(tmp_path: Path, monkeypatch, pg_intake, pg_catalogs) -> None:
...
def test_jobs_api(tmp_path: Path, monkeypatch, pg_intake, pg_catalogs) -> None:
