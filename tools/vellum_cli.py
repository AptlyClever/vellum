...
Usage:
  ...
  python tools/vellum_cli.py pull --lane project-a --target ./res/assets/vellum/
"""
...
DEFAULT_VELLUM_API = "http://127.0.0.1:8770"
...
def main() -> None:
    ...
    pull_parser.add_argument("--lane", required=True, help="Target game lane (e.g. field-ops, project-a)")
