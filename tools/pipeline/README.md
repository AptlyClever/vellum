...
$proj = "D:\Games\VellumLibrary\VellumLibrary.uproject"
$script = "D:\dev\vellum\tools\pipeline\jobs\export_models.py"
& $ue $proj `
  -unattended -nopause -nosplash -NullRHI `
  "-ExecutePythonScript=$script" `
  -AbsLog="D:\Games\VellumLibrary\Saved\VellumPipeline\export-models.log"
```
