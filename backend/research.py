...
Persists metadata in Postgres (``vellum.catalogs``, name ``"visual_research"``,
mirrored to vault 02-index for human browsing -- see ``backend/pg_catalog.py``)
