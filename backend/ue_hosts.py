"""UE host profiles (Factory asset/factory host; Studio dev workstation)."""
...
def active_host_id(doc: dict[str, Any] | None = None) -> str:
    ...
    return str(data.get("active") or "factory").strip().lower()
...
def default_project_dir() -> str:
    host = get_host()
    return str(host.get("project_dir") or host.get("project") or r"D:\Games\VellumLibrary")
